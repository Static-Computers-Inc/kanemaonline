...
class VerifyCredentialOTP extends StatefulWidget {
  final String credential;
  final bool isPhonenumber;
  const VerifyCredentialOTP({
    super.key,
  ...
  @override
  State<VerifyCredentialOTP> createState() => _VerifyCredentialOTPState();
}

class _VerifyCredentialOTPState extends State<VerifyCredentialOTP> {
  ...
  void verifyOTP(dynamic otp) async {
    ...
    try {
      ...
      if (widget.isPhonenumber) {
        await UsersAPI.changePhonenumber(phoneNumber: widget.credential);
      } else {
        await UsersAPI.changeEmail(email: widget.credential);
      }
